module Route.Confirmed exposing (Model, Msg, RouteParams, route, Data, ActionData)
...
head app =
    Seo.summaryLarge
        ...
        , description = "Thank you for signing up for updates on jazz performances from Dillon Kearns"
        , locale = Nothing
        , title = "You're all set! - Dillon Kearns"
        }
        |> Seo.website
        ...
        [ Html.div
            ...
            [ Html.div
                ...
                [ Html.h2
                    ...
                    [ Html.text "You're all set!" ]
                , Html.p
                    [ Attr.class "text-lg text-white/90 max-w-xl mx-auto"
                    ]
                    [ Html.text "Thank you so much for joining! You'll be hearing from me soon with upcoming shows and some of my favorite videos and moments from gigs around town." ]
                ]
            ]
        ]
